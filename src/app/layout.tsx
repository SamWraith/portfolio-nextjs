    ...
    return (
        <html lang="en" className="!scroll-smooth">
            ...
            >
                ...
                <div className="bg-[#dbd7fb] absolute top-[-1rem] -z-10 left-[-35rem]  w-[50rem] rounded-full blur-[10rem] sm:w-[68.75rem] md:left-[-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem]"></div>
